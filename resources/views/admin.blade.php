...
@section('content')
    ...
    <div class="container">
        <form method="POST" action="{{ route('store_course') }}">
            ...
            <div class="data_input">
                ...
                <textarea type="text" id="short_description" name="short_description" placeholder="Минимум 100 символов" required
    ...
    <form method="POST" action="{{ route('store_lesson') }}">
        ...
        <div class="data_input">
            ...
            <div class="input_name_lesson">
                <input type="text" id="name" name="name" required max="25">
